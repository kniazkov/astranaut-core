...
import org.cqfn.astranaut.core.algorithms.patching.DefaultPatcher;
import org.cqfn.astranaut.core.algorithms.patching.Patcher;
 ...
 * Testing class.
 */
public class T07_PatternPatching {
    /**
     * Starting point.
    ...
    public static void main(String[] args) {
        ...
        final Node patched = patcher.patch(other, pattern);

        String image = args[2] + ".patched.png";
        TreeVisualizer visualizer = new TreeVisualizer(patched);
        try {
